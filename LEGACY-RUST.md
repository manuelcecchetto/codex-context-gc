...
Historical instructions for the custom CLI build. This route has the macOS signing incompatibility described below. For desktop installation use [README.md](README.md).
